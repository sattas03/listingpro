...
//                                                    the_post_thumbnail('full');
                                                ...
                                                if ($blog_view == 'list_view') {
                                                    echo '<img src="' . esc_html__('https://via.placeholder.com/305x200', 'listingpro') . '" alt="image">';
                                                } else {
                                                    echo '<img src="' . esc_html__('https://via.placeholder.com/600x240', 'listingpro') . '" alt="image">';
                                                }
                            ...
                            <div class="lp-blog-grid-box-thumb">
                                <a href="<?php the_permalink(); ?>">
                                    ...
                                    if ( has_post_thumbnail() ) {
                                        ...
                                        if( $blog_view == 'list_view2' )
                                        {
                                            echo '<img src="'.esc_html__('https://via.placeholder.com/770x460', 'listingpro').'" alt="image">';
                                        }
                                        else
                                        {
                                            echo '<img src="'.esc_html__('https://via.placeholder.com/368x220', 'listingpro').'" alt="image">';
                                        }
                            ...
                            <div class="lp-blog-grid-box-thumb">
                                <a href="<?php the_permalink(); ?>">
                                    ...
                                    if ( has_post_thumbnail() ) {
                                        ...
                                        if( $blog_view == 'list_view' )
                                        {
                                            echo '<img src="'.esc_html__('https://via.placeholder.com/1170x440', 'listingpro').'" alt="image">';
                                        }
                                        else
                                        {
                                            echo '<img src="'.esc_html__('https://via.placeholder.com/368x220', 'listingpro').'" alt="image">';
                            ...
                            <div class="lp-blog-grid-box-thumb">
                                <a href="<?php the_permalink(); ?>">
                                    ...
                                    if ( has_post_thumbnail() ) {
                                        ...
                                        {
                                            echo '<img src="'.esc_html__('https://via.placeholder.com/270x270', 'listingpro').'" alt="image">';
                                        }
