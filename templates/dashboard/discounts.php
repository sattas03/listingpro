                                                            ...
                                                            <div class="jFiler-input-dragDrop pos-relative">
                                                                ...
                                                                <div class="upload-field dashboard-upload-field edit-upload-<?php echo $disID; ?>">
                                                                    ...
                                                                    if( !empty( $discount_data['disImg'] ) ):
                                                                        ?>
                                                                        <img class="lp-uploaded-img event-old-img-<?php echo $disID; ?>" src="<?php echo $discount_data['disImg']; ?>" alt="image">
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="lp-coupon-box-row">
                                                    ...
                                                    <div class="row margin-bottom-10">
														...
														<div class="col-sm-6 ">
															...
															<div class="pos-relative" id="time-switch">
																...
																<input name="dis-time-s-<?php echo $disID; ?>" id="dis-time-s-<?php echo $disID; ?>" type="text" class="form-control datetimepicker1 lp-dashboard-text-field lp-pos-relative-input " placeholder=" Time" value="<?php echo $discount_data['disTimeS']; ?>" >
													...
													<div class="row">	
														...
														<div class="col-sm-6 ">
															...
															<div class="pos-relative" id="time-switch">
																<span class="lp-field-icon"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
																<input name="dis-time-e-<?php echo $disID; ?>" id="dis-time-e-<?php echo $disID; ?>" type="text" class="form-control datetimepicker1 lp-dashboard-text-field lp-pos-relative-input " placeholder=" Time" value= "<?php echo $discount_data['disTimeE']; ?>">
                        ...
                        <div class="lp-coupon-box-row">
                            ...
                            <div class="row margin-bottom-10">
                                ...
                                <div class="col-sm-6 ">
                                    ...
                                    <div class="pos-relative" id="time-switch">
                                        <span class="lp-field-icon"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
                                        <input name="dis-time-s" id="dis-time-s" type="text" class="form-control datetimepicker1 lp-dashboard-text-field lp-pos-relative-input " placeholder=" <?php echo esc_html__('Time', 'listingpro'); ?>">
                            ...
                            <div class="row lp-cpn-end-container">
                                ...
                                <div class="col-sm-6 ">
                                    ...
                                    <div class="pos-relative" id="time-switch">
                                        <span class="lp-field-icon"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
                                        <input name="dis-time-e" id="dis-time-e" type="text" class="form-control datetimepicker1 lp-dashboard-text-field lp-pos-relative-input " placeholder=" <?php echo esc_html__('Time', 'listingpro'); ?>">
