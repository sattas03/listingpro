            ...
            if(empty($showAC)){
                ...
                if(!empty($budget)){
                    if( $currency_position == 'right' ){
                        ...
                        $selctedAmount = '<h4>'.$currency.' '.$budget;'</h4>';
                    }
...
<div class="tab-pane fade in active lp-new-ad-compaign padding-bottom-50" id="lp-listings">
    ...
    <div class="clearfix lp-ad-step-two lp-ads-form-container">
        ...
        <div class="col-md-9 lp-compaignForm-leftside">
            ...
            <form id="lp-new-ad-compaignForm" method="POST" name="lp-new-ad-compaignForm" data-string="<?php esc_html_e('Minimum Budget Must Be Greater Then', 'listingpro'); ?>" data-type="<?php echo $typeofcampaign; ?>" data-tax-percent="<?php echo $taxPerfent; ?>" data-camp-currency="<?php echo $currencyCode; ?>" action="<?php echo esc_url($ads_promo_url); ?>">
