                ...
                <div class="panel with-nav-tabs panel-default lp-dashboard-tabs col-md-11 align-center" id="lp-listings">
                    ...
                    <div class="panel-body lp-new-packages" id="lp-new-invoices">
                        <div class="lp-main-title clearfix">
                            ...
                            <div class="col-md-2 text-center"><p><?php esc_html_e('Listing Title', 'listingpro'); ?></p></div>
                            ...
                            <div class="">
                                ...
                                foreach ($userSubscriptions as $subscription) {
                                    ...
                                    try {
                                        ...
                                        if ((isset($subscription['method'])) && ($subscription['method'] == 'razorpay' || $subscription['method'] == 'paystack' || $subscription['method'] == 'payfast')) {
                                        ...
                                        <div class="lp-listing-outer-container clearfix">
                                            ...
                                            <div class="col-md-2 padding-0"><?php echo $subscrID; ?></div>
                                            <div class="col-md-2 text-center"><?php echo $listing_title; ?></div>
                                            ...
                                            if ((isset($subscription['method'])) && ($subscription['method'] == 'razorpay' || $subscription['method'] == 'paystack' || $subscription['method'] == 'payfast')) {
                                                ...
                                                <?php
                                                    ...
                                                    <div class="col-md-2 padding-0"><?php echo $currency . $myPrice->price . " ($taxStatus)"; ?></div>
                                                <?php }
                                            } else {
                                                ?>
                                                <div class="col-md-2"><?php if (!empty($plan_price)) : echo $plan_price . " ($taxStatus)"; endif; ?></div>
                                                <?php
                                            }
                                            ?>
