                                                                ...
                                                                <div class="jFiler-input-dragDrop pos-relative">
                                                                    ...
                                                                    <div class="removeable-image upload-field dashboard-upload-field edit-upload-<?php echo $eID; ?>">
                                                                        ...
                                                                        if( !empty( $eImg ) ):
                                                                            ...
                                                                            <img class="lp-uploaded-img event-old-img-<?php echo $eID; ?>" src="<?php echo $eImg; ?>" alt="image">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <select class="form-control event-tickets-platforms lp-dashboard-select-box">
                                                                        ...
                                                                        <option><?php echo esc_html__('Facebook', 'listingpro'); ?></option>
                                                                        <option><?php echo esc_html__('Twitter', 'listingpro'); ?></option>
