...
if ( is_front_page() && is_home()  )
{
    ...
    /*Eventpro Banner for front page*/
    if ($ep_home_banner_switch=='1' && $curr_page_id == $ep_page_select && $ep_banner_style == 'ep_banner1') {
        include (EVENTPRO_PLUGIN_PATH.'/templates/ep-search/ep-home-search-view1.php');
    }
    else{
        ?>
