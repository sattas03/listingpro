...
if( !empty( $IDs )):
    ...
    <div class="lp-listing-slider" data-totalSlides="<?php echo $numImages; ?>">
...

        {
            ...
            <div class="col-md-12 lp-listing-slide-wrap">
                ...
                <div class="lp-listing-slide">
                    ...
                    <a href="<?php echo $img_url[0]; ?>" rel="prettyPhoto[gallery1]">

                        <img src="<?php echo $img_thumb; ?>" alt="<?php the_title(); ?>">
