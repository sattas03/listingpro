...
if( ( $listing_mobile_view == 'app_view' || $listing_mobile_view == 'app_view2' ) && wp_is_mobile() && !is_page_template('template-dashboard.php')){
    ...
    if($footerNeed == true) {
        if (!is_page_template('template-dashboard.php')) {
            ?>
            <!--==================================Footer Open=================================-->
            <?php if ($ep_footer_style == 'ep_footer1' && $ep_footer_switch=='1' ) {?>
                <!-- Eventpro Footer style 1 -->
                <?php include_once(EVENTPRO_PLUGIN_PATH.'/templates/footers/ep-footer-style1.php');?>
