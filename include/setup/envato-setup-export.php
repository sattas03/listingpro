...
if ( is_dir( $dir ) ) {
    ...
    $wp_filesystem->put_contents($dir . 'default.json', json_encode( $default_content ));
    $wp_filesystem->put_contents($dir . 'widget_positions.json', json_encode( $widget_positions ));
    $wp_filesystem->put_contents($dir . 'widget_options.json', json_encode( $widget_options ));
    $wp_filesystem->put_contents($dir . 'menu.json', json_encode( $menu_ids ));
    $wp_filesystem->put_contents($dir . 'options.json', json_encode( $my_options ));
