...
if(!empty($_POST['post_id']) && isset($_POST['post_id']) && !empty($_POST['method']) && isset($_POST['method'])){
	...
	$coupon = '';
    $copontype = '';
        $couponChek = isset($_POST['lp_checkbox_coupon']) ? $_POST['lp_checkbox_coupon'] : '';
    ...
    $coupon = isset($_POST['coupon-text-field']) ? $_POST['coupon-text-field'] : '';
    ...
    if(!empty($Taxratee)){
        $taxprice = (float)$_POST['listings_tax_price'];
