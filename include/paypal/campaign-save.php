...
if(!function_exists('lp_save_campaign_data')){
    function lp_save_campaign_data($price_packages, $transactionID, $method, $token, $status,$price= '', $budget = '', $listing_id='', $adsofType, $ads_days, $ads_price, $taxPrice, $user_id = 0){
