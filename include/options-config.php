...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'desc' => __('Enable to display a page title for non-directory pages such as about, contact ect. This will not affect directory pages such as listing search results (archive) and listing details page.', 'listingpro'),
            'default' => 1,
        ),
        array(
