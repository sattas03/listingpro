                                    ...
                                    foreach (NextendSocialLogin::$providers AS $provider){
                                        ...
                                        <li>
                                            <a id="logingoogle" class="google flaticon-googleplus"
                                               href="<?php echo get_site_url(); ?>/wp-login.php?loginGoogle=1"
                                               onclick="window.location = '<?php echo get_site_url(); ?>/wp-login.php?loginGoogle=1&redirect='+window.location.href; return false;">
                                                <span class="lp-pop-icon-img"><img
                                                            src="<?php echo listingpro_icons_url('google_login'); ?>"></span>
                                                <span><?php esc_html_e('Google Login', 'listingpro'); ?></span>
                                            </a>
                                        </li>
                                        <?php }if($providerLable=="Facebook"){ ?>
                                        <li>
                                            <a id="loginfacebook" class="facebook flaticon-facebook"
                                               href="<?php echo get_site_url(); ?>/wp-login.php?loginFacebook=1"
                                               onclick="window.location = '<?php echo get_site_url(); ?>/wp-login.php?loginFacebook=1&redirect='+window.location.href; return false;">
                                                <span class="lp-pop-icon-img"><img
                                                            src="<?php echo listingpro_icons_url('facebook_login'); ?>"></span>
                                                <span><?php esc_html_e('Facebook Login', 'listingpro'); ?></span>
                                            </a>
                                        </li>
                                            <?php }if($providerLable=="Twitter"){ ?>
                                        <li>
                                            <a id="logintwitter" class="twitter flaticon-twitter"
                                               href="<?php echo get_site_url(); ?>/wp-login.php?loginSocial=twitter"
                                               onclick="window.location = '<?php echo get_site_url(); ?>/wp-login.php?loginSocial=twitter&redirect='+window.location.href; return false;">
                                                <span class="lp-pop-icon-img"><img
                                                            src="<?php echo listingpro_icons_url('twitter_login'); ?>"></span>
